...
superseded_by: geopolitics-v2-wartime
archive_reason: 2026-07-25 慢思考复核判质变，v2 战时专框激活门槛 A（霍尔木兹实弹封锁≥5交易日、Kpler 确认零通行）+ B（美伊第27波持续规模交火）决定性命中。path A 连续 13 天=0、D=69 烈度钉死 10，A/B/C/D 缓和阶梯已无法表征战时 regime。本文件退役归档，不再被任何脚本加载（framework_loader 只读 framework.md）。
---

> ⚠️ **本文件已退役（2026-07-25）**，仅作历史留痕。在役框架是同目录 `framework.md`（geopolitics-v2-wartime）。
> 2026-07-25 之前的 report_state 按本框架（A/B/C/D 分型）解读；之后按 v2（W1-W4/De 战争轨迹）解读，trace 在换代日画分界线。

---

# geopolitical_daily 分析框架 · v1 全球地缘风险（已退役）
