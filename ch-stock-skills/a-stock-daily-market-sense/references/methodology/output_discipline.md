...
- 高亮定性段落：每个一级大章节（1-5）里已有的总结/定性段落必须用 `==...==` 包裹，例如”指数趋势判断””市场风格判断””盘面定性””拥挤度判断””主线 vs 资金轮动结论””风险传导提示””特征分组一句话判断”。不要额外新增”本节总结”段落；高亮的是原本就承担总结作用的段落。
- 数据缺失或模块跳过时，要明确说明，并引用脚本给出的跳过原因。
- 3.2 三星门禁：最终聚合必须先检查 3.1 星级。只有至少一个 ★★★ 主线时才允许输出 `3.2 催化与细分线路推演`，且本节只能包含 ★★★ 主线；★ 与 ★★ 方向不得搜索、推演或进入本节。若 3.1 没有 ★★★，必须删除整个 3.2，包括标题与兜底句。
