...
覆盖全部 ★★/★★★ 主线，以及最多 2 个成交额靠前或事件明确的 ★ 级早期方向。事实、推演、盘面验证分开写；搜索失败时明确披露，不得从涨跌反推事件。

| 主线/早期方向 | 事件事实（来源·日期） | 变量变化与传导 | 细分线路 | 产业逻辑 | 盘面验证 | 后续反证 |
|---|---|---|---|---|---|---|
|  |  |  |  | 强/中/线索 | 已确认/萌芽/未确认 |  |

每条主线最多保留 1-3 条细分线路。产业逻辑与盘面验证是两根独立轴；只有产业推演、没有 M3 强势池成员时写“未确认”，不能据此改变 3.1 星级。事件事实使用 Markdown 链接。
